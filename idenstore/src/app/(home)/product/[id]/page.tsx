    ...
    <main className={styles.main}>
      <div className={`container ${styles.container}`}>
        ...
        <div className={styles.product}>
          ...
          {!loading? <span className={styles.priceCredit}>{product?.price / 3} ₽/мес. в <p>рассрочку</p> на 3 месяца  за </span> : <Placeholder.Graph active style={{ height: 15, width: 380, marginTop: 14 }} />}
